        ...
        <CardContent className="space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            ...
            <p className="text-xs text-blue-700 dark:text-blue-300">
              This application integrates Google Cloud Storage, Gemini AI, and Google OAuth 
              to provide enterprise-grade legal research capabilities.
            </p>
          </div>
          ...
          <div className="text-center">
            <p className="text-xs text-muted-foreground">
              ...
              Your legal documents are processed securely using Google Cloud services.
            </p>
          </div>
        </CardContent>
      </Card>
